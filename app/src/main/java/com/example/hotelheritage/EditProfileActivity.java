...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbRef = FirebaseDatabase.getInstance().getReference().child("Users/1");
        ...
        saveChanges.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbRef.child("Users").child("1").child("name").setValue(epName.getText().toString().trim());
                dbRef.child("Users/1/conNo").setValue(epPhone.getText().toString().trim());
                dbRef.child("Users/1/dob").setValue(epDob.getText().toString().trim());
                dbRef.child("Users/1/email").setValue(epEmail.getText().toString().trim());
                dbRef.child("Users/1/username").setValue(epUsername.getText().toString().trim());
    ...
    private void alertDialog() {
        ...
        dialog.setNegativeButton("Yes",new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dbRef = FirebaseDatabase.getInstance().getReference().child("Users").child("1");
                dbRef.removeValue();
